# The values below are those that are specific to the CONi structure, only the l,m,h numbers should change
...
# binding energy Co Ni@I low: -1.49 eV  high: -0.18 eV
#          [CONi@I]
en_bindl = -1.49
en_bindm = -0.89
en_bindh = -0.18
...
E6lowact = 0.94   #### not used
E6lowreact = -1.08   #### not used
E16lowact = 0.70
E16lowreact = -0.10
