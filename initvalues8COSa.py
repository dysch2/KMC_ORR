# The values below are those that are specific to the COSa structure, only the l,m,h numbers should change
...
# binding energy CO Sand low: -1.23 eV  high: -0.37 eV
#          [COSa]
en_bindl = -1.23
en_bindm = -0.54
en_bindh = -0.37
...
E1highact = 1.09   #### not used
E1highreact = -1.22   #### not used
E2highact  = 1   #### not used
E2highreact  = -1   #### not used
E5highact = 0.19 #0.19 value changed as otherwise this would be the only event
E5highreact = -1.36 # really -0.36 but increased to allow the system to work
E6highact = 0.48 # values for these two unknown but assumed similar
E6highreact = -2.50
