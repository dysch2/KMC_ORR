# The values below are those that are specific to the TOSa structure, only the l,m,h numbers should change
...
# binding energy TO Sand low: -1.11 eV  high: -0.69 eV
#          [TOSa]
en_bindl = -1.11
en_bindm = -0.59
en_bindh = -0.69
...
E6lowact = 0.84   #### not used
E6lowreact = -0.29   #### not used
E16lowact = 0.51
E16lowreact = -0.27

E1highact = 1.45   #### not used
E1highreact = -0.78   #### not used
